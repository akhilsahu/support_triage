...
export function Header({ title, subtitle }: HeaderProps) {
  ...
  return (
    <header className="relative z-10 flex items-center gap-4 px-6 py-4 bg-white dark:bg-white/10 dark:backdrop-blur-md border-b border-gray-200 dark:border-white/10 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold ${dt.quickCreate} text-white rounded-lg transition-colors`}
        >
