...
const THEMES = {
  ...
  homepage4: {
    ...
    navBg:          'sticky top-0 z-40 flex items-center justify-between px-8 py-4 bg-white/90 backdrop-blur-md border-b border-slate-100',
    logoText:       'font-bold text-slate-900 tracking-tight',
    navMidLink:     'text-sm text-slate-500 hover:text-slate-900 transition-colors',
    signInLink:     'text-sm text-slate-500 hover:text-slate-900 font-medium px-3 py-1.5',
    ctaBtn:         'text-sm bg-gradient-to-r from-violet-600 to-teal-500 text-white font-semibold px-4 py-2 rounded-xl shadow-md shadow-violet-200',
    headerBg:       'bg-gradient-to-br from-violet-50 via-slate-50 to-teal-50 border-b border-slate-100 px-8 py-16 text-center',
    backLink:       'inline-flex items-center gap-1.5 text-xs text-violet-600 font-medium mb-6 hover:underline',
    h1:             'text-4xl font-bold text-slate-900 mb-3 tracking-tight',
    subtitle:       'text-slate-500 max-w-xl mx-auto text-base',
    contentBg:      'flex-1 px-8 py-12 max-w-3xl mx-auto w-full',
    ...
    accentLink:     'text-violet-600 hover:underline',
    footerWrap:     'border-t border-slate-100 text-slate-500 px-8 pt-14 pb-8 bg-slate-50',
    footerTagline:  'text-xs leading-relaxed text-slate-500 font-medium',
    footerColHead:  'text-slate-800 text-xs font-semibold uppercase tracking-wider mb-4',
    footerColLink:  'text-xs text-slate-500 hover:text-slate-900 transition-colors',
    footerCopyBd:   'border-slate-200',
    footerCopyText: 'text-xs text-slate-400',
    footerCopyLink: 'text-xs text-slate-400 hover:text-slate-700 transition-colors',
    footerBorder:   'border-t border-slate-100 px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-slate-400',
    footerLink:     'hover:text-slate-700',
    stepIcon:       'bg-gradient-to-br from-violet-500 to-teal-500',
    stepTitle:      'font-bold text-slate-900 mb-1',
    stepBody:       'text-slate-500 text-sm leading-relaxed',
    bullet:         'bg-gradient-to-r from-violet-500 to-teal-500',
    featTitle:      'font-semibold text-slate-900',
    featDesc:       'text-slate-500',
    featBorder:     'border-b border-slate-100 last:border-0',
    pricingHL:      'border-violet-300 shadow-xl shadow-violet-100 bg-white',
    pricingNorm:    'border-slate-200 bg-slate-50',
    pricingName:    'text-sm font-semibold text-slate-500 mb-1',
    pricingPrice:   'text-3xl font-bold text-slate-900 mb-1',
    pricingDesc:    'text-sm text-slate-500 mb-5',
    pricingFeat:    'text-sm text-slate-700 flex gap-2',
    pricingCheck:   'text-violet-500',
    pricingCtaHL:   'block text-center text-sm font-semibold py-2.5 rounded-xl transition-colors bg-gradient-to-r from-violet-600 to-teal-500 text-white hover:from-violet-700 hover:to-teal-600 shadow-md shadow-violet-200',
    pricingCtaNorm: 'block text-center text-sm font-semibold py-2.5 rounded-xl transition-colors bg-slate-100 text-slate-700 hover:bg-slate-200',
    contactCard:    'p-5 rounded-2xl',
    contactLabel:   'text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1',
    contactLink:    'text-sm font-medium text-violet-600 hover:underline',
    authCard:       'bg-white border border-slate-200',
    authInput:      'bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:border-violet-400 focus:ring-4 focus:ring-violet-100',
    authBtn:        'bg-gradient-to-r from-violet-600 to-teal-500 hover:from-violet-700 hover:to-teal-600 text-white shadow-md shadow-violet-200',
    authBackLink:   'text-slate-400 hover:text-slate-700',
    authHomeBtn:    'bg-white border border-slate-200 text-slate-500 hover:text-slate-900',
    authCopyright:  'text-slate-400',
    authIconBg:     'bg-gradient-to-tr from-violet-600 to-teal-500 shadow-md shadow-violet-200',
    authLabelText:  'text-slate-700',
    authGlow1:      'bg-violet-400/10',
    authGlow2:      'bg-teal-400/10',
  },
}
