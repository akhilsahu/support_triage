...
function OrgSearch() {
  ...
  const go = (slug: string) => navigate(`/s/${slug}`)
    ...
    <div className="flex flex-col" style={{
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-8 py-5 border-b border-white/5"
        ...
        <div className="flex items-center gap-3">
          <Link to="/login" className="text-sm text-gray-400 hover:text-white font-medium px-3 py-1.5 transition-colors">
            Sign in
          </Link>
          <Link to="/login"
      ...
      <section id="how-it-works" className="px-8 py-28 border-t border-white/5" style={{ background: '#0d0f1c' }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-bold text-violet-400 uppercase tracking-[0.25em] mb-4">Get started</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/5">
            {[
              { step: '1', color: 'from-indigo-500 to-indigo-600', title: 'Register your org',  desc: 'Create an account, choose a slug, and your branded chat page is live immediately.' },
              { step: '2', color: 'from-violet-500 to-violet-600', title: 'Configure agents',   desc: 'Enable specialist agents and upload your knowledge base. No code needed.' },
              { step: '3', color: 'from-purple-500 to-purple-600', title: 'Share the link',     desc: 'Embed on your site or let customers find you through SUPPORT247.chat search.' },
      ...
      {/* ── CTA ────────────────────────────────────────────────────────────── */}
      <section className="px-8 pb-28 border-t border-white/5" style={{ background: '#0f1120' }}>
