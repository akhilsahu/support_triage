                  ...
                  <div key={i} className="flex gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {a.intent && <span className={`text-[11px] font-semibold ${theme.textAccent}`}>{a.intent}</span>}
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className={`text-xs font-semibold ${theme.textAccent} ${theme.hoverAccent} flex items-center gap-1 transition-colors`}
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                {stats.fleet.map(agent => {
                  ...
                  return (
                    <div key={agent.slug}
                      className={`bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-4 shadow-sm hover:shadow-md hover:${theme.borderAccent} transition-all`}>
