...
async def generate_doc_metadata_suggestion(
    *,
    ...
    prompt = (
        ...
        "1. 'doc_type': Identify exact document classification (e.g. 'Terms & Conditions', 'Fee Schedule & Charges', 'Policy Document', 'User Manual', 'Product Brochure', 'Legal Notice').\n"
        "2. 'scope': Identify explicit coverage scope (e.g. 'All SBI Credit Card Variants (Portfolio-wide)', 'SBI Cashback Card Only', 'Enterprise-wide HR Policy').\n"
        "3. 'description': Write a comprehensive, accurate 2-3 sentence summary describing the FULL SCOPE and categories of information in this document. CRITICAL RULES:\n"
        ...
        "4. 'topic': A clean 1-3 word primary category/subject (e.g. 'SBI Credit Card MITC', 'Refund Policy', 'Employee Handbook').\n"
        "5. 'tags': 4-7 representative, high-value citation tags covering core document categories and sub-topics (e.g. ['MITC', 'Terms & Conditions', 'Schedule of Charges', 'Finance Charges', 'Late Payment Fees', 'Cardholder Obligations'])."
        "\n\n"
        f"Filename/Title: {file_title}\n"
        f"URL: {source_url}\n"
        f"Content Excerpt (Full Context):\n{snippet}\n\n"
        "Return ONLY a raw JSON object with keys:\n"
        "  - 'doc_type': classification string\n"
